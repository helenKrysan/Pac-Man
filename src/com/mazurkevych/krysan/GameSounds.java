...
public class GameSounds {
	...
	public GameSounds() {
		...
		try {
			// Pacman eating sound
			url = this.getClass().getClassLoader().getResource("pacman_intermission.wav");
			audioIn = AudioSystem.getAudioInputStream(url);
			nomNom = AudioSystem.getClip();
			nomNom.open(audioIn);

			// newGame
			url = this.getClass().getClassLoader().getResource("pacman_beginning.wav");
			audioIn = AudioSystem.getAudioInputStream(url);
			newGame = AudioSystem.getClip();
			newGame.open(audioIn);

			// death
			url = this.getClass().getClassLoader().getResource("pacman_death.wav");
			audioIn = AudioSystem.getAudioInputStream(url);
